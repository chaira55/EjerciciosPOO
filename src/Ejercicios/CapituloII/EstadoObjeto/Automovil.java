...
public class Automovil {
    ...
    public Automovil(String marca, int modelo, int motor,
            Ejercicios.CapituloII.EstadoObjeto.Automovil.TipoCombustible tipoCombustible,
            Ejercicios.CapituloII.EstadoObjeto.Automovil.TipoAutomovil tipoAutomovil, int cantPuertas, int cantAsientos,
